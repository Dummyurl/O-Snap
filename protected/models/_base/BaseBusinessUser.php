 ...
 * property or method in class "BusinessUser".
 *
 ...
 *
 */
abstract class BaseBusinessUser extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'BusinessUser|BusinessUsers', $n);
	}
	...
	public function search() {
		...
		$criteria->condition .= "user_type IN (2)";
