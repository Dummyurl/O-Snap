 ...
 * @property integer $business_esta_month
 * @property integer $business_esta_year
 ...
 * @property integer $security_code
 *
 */
abstract class BaseUser extends GxActiveRecord {
	...
	public function rules() {
		return array(
			//array('osnap_id, business_osnap_id, username, password, email, first_name, last_name, birth_date, country_code, phone, city, state, country, post_code, address, latitude, longtitude, image, user_type, parent_user, business_name, business_type, business_category, business_owner, business_image, business_notes, business_esta_month, business_esta_year, exp_level, status, auth_id, auth_provider, token, created_at, device_type, device_token, activation_code, forget_pass_code, base, security_code', 'required'),
			array('user_type, parent_user, business_type, business_category, business_esta_month, business_esta_year, exp_level, status, device_type, base, is_active, is_agree, security_code', 'numerical', 'integerOnly'=>true),
			...
			array('id, osnap_id, business_osnap_id, username, password, email, first_name, last_name, birth_date, country_code, phone, city, state, country, post_code, address, latitude, longtitude, image, user_type, parent_user, business_name, business_type, business_category, business_owner, business_image, business_notes, business_esta_month, business_esta_year, exp_level, status, auth_id, auth_provider, token, created_at, device_type, device_token, activation_code, forget_pass_code, base, is_active, is_agree, security_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'business_notes' => Yii::t('app', 'Business Notes'),
			'business_esta_month' => Yii::t('app', 'Business Esta Month'),
			'business_esta_year' => Yii::t('app', 'Business Esta Year'),
	...
	public function search($user_type = NULL) {
		...
		$criteria->compare('business_notes', $this->business_notes, true);
		$criteria->compare('business_esta_month', $this->business_esta_month);
		$criteria->compare('business_esta_year', $this->business_esta_year);
		...
		$criteria->compare('security_code', $this->security_code);
