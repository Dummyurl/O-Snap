 ...
 * property or method in class "BusinessCategory".
 *
 ...
 *
 */
abstract class BaseBusinessCategory extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'BusinessCategory|BusinessCategories', $n);
	}
